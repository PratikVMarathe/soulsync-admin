const icons = {
  ...
  eyeOff: (
    <>
      <path d="M3 3l18 18" />
      <path d="M10.58 10.58A3 3 0 0 0 14.83 14.8" />
      <path d="M9.88 5.09A10.94 10.94 0 0 1 12 4c5.5 0 9.5 4 10.9 8c-.63 1.8-1.69 3.43-3.1 4.75" />
      <path d="M6.53 6.53C4.59 7.87 3.19 9.79 2.1 12c1.8 4.7 5.9 8 9.9 8c1.61 0 3.13-.43 4.46-1.19" />
    </>
  ),
  alertTriangle: (
    <>
  ...
  pencil: (
    <>
      <path d="m12 20 8.5-8.5a2.1 2.1 0 0 0 0-3L18.5 6a2.1 2.1 0 0 0-3 0L7 14.5 6 19l4.5-1Z" />
  ...
  settings: (
    <>
      ...
      <path d="M19.4 15a1 1 0 0 0 .2 1.1l.1.1a2 2 0 1 1-2.8 2.8l-.1-.1a1 1 0 0 0-1.1-.2 1 1 0 0 0-.6.9V20a2 2 0 1 1-4 0v-.2a1 1 0 0 0-.6-.9 1 1 0 0 0-1.1.2l-.1.1a2 2 0 1 1-2.8-2.8l.1-.1a1 1 0 0 0 .2-1.1 1 1 0 0 0-.9-.6H4a2 2 0 1 1 0-4h.2a1 1 0 0 0 .9-.6 1 1 0 0 0-.2-1.1l-.1-.1a2 2 0 1 1 2.8-2.8l.1.1a1 1 0 0 0 1.1.2 1 1 0 0 0 .6-.9V4a2 2 0 1 1 4 0v.2a1 1 0 0 0 .6.9 1 1 0 0 0 1.1-.2l.1-.1a2 2 0 1 1 2.8 2.8l-.1.1a1 1 0 0 0-.2 1.1 1 1 0 0 0 .9.6H20a2 2 0 1 1 0 4h-.2a1 1 0 0 0-.4 1.6Z" /> */}
    </>
  ),
  shield: (
    <>
      <path d="M12 3 5.5 5.7v5.1c0 4.2 2.6 8 6.5 9.5 3.9-1.5 6.5-5.3 6.5-9.5V5.7L12 3Z" />
      <path d="M12 8v8" />
      <path d="M9 11h6" />
    </>
  ),
